    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-actions>
            ...
            <v-btn
                    ...
                    color="deep-purple lighten-2"
                    text
                    @click="openPickupMemu"
            >
                PickupMemu
            </v-btn>
            <v-dialog v-model="pickupMemuDiagram" width="500">
                <PickupMemuCommand
                        @closeDialog="closePickupMemu"
                        @pickupMemu="pickupMemu"
                ></PickupMemuCommand>
            </v-dialog>
            <v-btn
                    v-if="!editMode"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async pickupMemu(params) {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['pickupmemu'].href), params)
            ...
            openPickupMemu() {
                this.pickupMemuDiagram = true;
            },
            closePickupMemu() {
                this.pickupMemuDiagram = false;
            },
